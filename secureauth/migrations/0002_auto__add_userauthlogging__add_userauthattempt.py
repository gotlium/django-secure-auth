...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserAuthLogging'
        db.create_table(u'secureauth_userauthlogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'secureauth', ['UserAuthLogging'])

        # Adding model 'UserAuthAttempt'
        db.create_table(u'secureauth_userauthattempt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('attempt', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'secureauth', ['UserAuthAttempt'])


    def backwards(self, orm):
        # Deleting model 'UserAuthLogging'
        db.delete_table(u'secureauth_userauthlogging')

        # Deleting model 'UserAuthAttempt'
        db.delete_table(u'secureauth_userauthattempt')
