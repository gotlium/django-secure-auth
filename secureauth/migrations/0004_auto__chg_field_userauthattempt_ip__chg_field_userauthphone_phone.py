...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAuthAttempt.ip'
        db.alter_column(u'secureauth_userauthattempt', 'ip', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'UserAuthPhone.phone'
        db.alter_column(u'secureauth_userauthphone', 'phone', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'UserAuthAttempt.ip'
        db.alter_column(u'secureauth_userauthattempt', 'ip', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'UserAuthPhone.phone'
        db.alter_column(u'secureauth_userauthphone', 'phone', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=128, unique=True))
