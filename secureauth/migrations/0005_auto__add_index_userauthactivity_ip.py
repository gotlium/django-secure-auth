...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserAuthActivity', fields ['ip']
        db.create_index(u'secureauth_userauthactivity', ['ip'])


    def backwards(self, orm):
        # Removing index on 'UserAuthActivity', fields ['ip']
        db.delete_index(u'secureauth_userauthactivity', ['ip'])
