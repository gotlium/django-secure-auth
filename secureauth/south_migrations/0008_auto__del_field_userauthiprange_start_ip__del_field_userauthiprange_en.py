...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserAuthIPRange', fields ['user', 'start_ip', 'end_ip']
        db.delete_unique(u'secureauth_userauthiprange', ['user_id', 'start_ip', 'end_ip'])

        # Deleting field 'UserAuthIPRange.start_ip'
        db.delete_column(u'secureauth_userauthiprange', 'start_ip')

        # Deleting field 'UserAuthIPRange.end_ip'
        db.delete_column(u'secureauth_userauthiprange', 'end_ip')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserAuthIPRange.start_ip'
        db.add_column(u'secureauth_userauthiprange', 'start_ip',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserAuthIPRange.end_ip'
        db.add_column(u'secureauth_userauthiprange', 'end_ip',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'UserAuthIPRange', fields ['user', 'start_ip', 'end_ip']
        db.create_unique(u'secureauth_userauthiprange', ['user_id', 'start_ip', 'end_ip'])
    ...
    models = {
        ...
        u'secureauth.userauthiprange': {
            'Meta': {'unique_together': "(('user', 'ip_range'),)", 'object_name': 'UserAuthIPRange'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_range': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
