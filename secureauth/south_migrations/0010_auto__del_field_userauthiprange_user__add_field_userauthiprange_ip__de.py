...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserAuthIPRange.user'
        db.delete_column(u'secureauth_userauthiprange', 'user_id')

        # Adding field 'UserAuthIPRange.ip'
        db.add_column(u'secureauth_userauthiprange', 'ip',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['secureauth.UserAuthIP']),
                      keep_default=False)

        # Adding unique constraint on 'UserAuthIPRange', fields ['ip', 'ip_data', 'is_ip']
        db.create_unique(u'secureauth_userauthiprange', ['ip_id', 'ip_data', 'is_ip'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserAuthIPRange', fields ['ip', 'ip_data', 'is_ip']
        db.delete_unique(u'secureauth_userauthiprange', ['ip_id', 'ip_data', 'is_ip'])

        # Adding field 'UserAuthIPRange.user'
        db.add_column(u'secureauth_userauthiprange', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'UserAuthIPRange.ip'
        db.delete_column(u'secureauth_userauthiprange', 'ip_id')
    ...
    models = {
        ...
        u'secureauth.userauthiprange': {
            'Meta': {'unique_together': "(('ip', 'ip_data', 'is_ip'),)", 'object_name': 'UserAuthIPRange'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['secureauth.UserAuthIP']"}),
