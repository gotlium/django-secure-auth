...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAuthActivity.notified'
        db.add_column(u'secureauth_userauthactivity', 'notified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAuthActivity.notified'
        db.delete_column(u'secureauth_userauthactivity', 'notified')
