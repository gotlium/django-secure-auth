...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'UserAuthAttempt', fields ['ip']
        db.delete_unique(u'secureauth_userauthattempt', ['ip'])

        # Adding index on 'UserAuthAttempt', fields ['ip']
        db.create_index(u'secureauth_userauthattempt', ['ip'])
    ...
    models = {
        ...
        u'secureauth.userauthattempt': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.BigIntegerField', [], {'unique': 'True'})
        },
